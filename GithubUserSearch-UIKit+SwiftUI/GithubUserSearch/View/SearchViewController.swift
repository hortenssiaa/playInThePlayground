...
extension SearchViewController: UICollectionViewDelegate {
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let viewModel = UserProfileViewModel(network: NetworkService(configuration: .default), loginID: userID)
        let hostingView = UIHostingController(rootView: UserProfileView(viewModel: viewModel))
